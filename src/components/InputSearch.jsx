...
const InputSearch = () => {
  ...
  return (
    <form className="w-[400px] h-[40px] rounded-md  flex justify-between shadow-[2px_2px_50px_0_rgba(55,71,79,0.2)] border-[1px] border-[#eee]">
      <input onChange={handleChange} className="rounded-xl px-4 w-[300px] outline-none" type="text" name="name" placeholder="Search your pokemon!" autoComplete="off"/>
